...
class ArduPilotRoverNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('steering_mode', 'MANUAL')
        ...
        self.steering_mode = self.get_parameter('steering_mode').value
    ...
    def connect_to_rover(self):
        ...
        try:
            ...
            # Set mode to ACRO
            if self.set_mode(self.steering_mode):
                time.sleep(2)
                # Arm the rover
                self.arm_rover()
                # Request IMU data
    ...
    def cmd_vel_callback(self, msg):
        ...
        ### INVERTED SETUP
        self.current_steering = -int(np.clip((msg.angular.z + angular_trim) * 500, -1000, 1000))
